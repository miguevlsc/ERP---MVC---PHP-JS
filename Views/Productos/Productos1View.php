<section class="contenedor0">
    <div class="contenedor1 flex">
        <h1 class="center">CONSULTAR - PRODUCTOS</h1>
        <div id="contenedor0" class="contenedor0">
        <input type="hidden" name="controlador" id="controlador1" value="Controllers/Productos1Controller.php">
            <div id="contenedor1" class="contenedor1">
                ...
                <a href="crearProducto.php"><button class="boton1">Añadir producto</button></a>
            </div>
        </div>
    </div>
    <div id="contenedor2" class="contenedor2">  
        <?php require_once "Controllers/Productos1Controller.php"; ?>
    </div>
