<section class="contenedor0">
    <div class="contenedor1 flex">
        <h1 class="center">CONSULTAR COMPRAS PROVEEDOR</h1>
        <div id="contenedor0" class="contenedor0 center">
            <input type="hidden" name="controlador" id="controlador1" value="Controllers/CompraProveedor1Controller.php">
    ...
    <div id="contenedor2" class="contenedor2">  
        <?php require_once "Controllers/CompraProveedor1Controller.php"; ?>
    </div>
